...
static void print_help_message(response_cb write_handler)
{
    ...
    cli_printf(write_handler, " led <color> - Set the LED color. Available colors: red, green, "
                              "blue, white, off\r\n\r\n");
}
...
static void color_handle_result(response_cb write_handler, char *color_text, uint32_t length_color,
